...
def script_args():
    parser = argparse.ArgumentParser(
        description='Article clustering for StockNewsAPI', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('--threshold', help='The maximum distance between articles that will be accepted in the cluster. Increasing this number decreases the size of clusters',
    ...
    def _load(self, clusters_df):
        ...
        for group in grouped_articles:
            ...
            for cluster in clusters:
                ...
                insert_cluster(clustered_articles)
