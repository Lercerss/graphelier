...
import { Styles } from '../styles/OrderBookPlayback';
import {
    dateStringToEpoch,
    nanosecondsToString,
...
class OrderBookPlayback extends Component<WithStyles, State> {
    /**
...
export default withStyles(styles)(OrderBookPlayback);
